      ...
      <main className="flex-1 flex flex-col max-w-lg mx-auto w-full pb-32 overflow-y-auto hide-scrollbar">
        <section className="p-8 flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium">johndoe@example.com</p>
          </div>
          <div className="flex w-full gap-3">
            ...
            <button className="flex-1 bg-primary hover:bg-primary/90 text-background-dark font-bold py-3 px-6 rounded-lg transition-colors text-sm">
              Logout
            </button>
          </div>
        </section>
